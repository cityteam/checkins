...
// Represents a list of mat numbers, made up of ranges and individual numbers
// (for example, "1-3,5,9-12").  Mat numbers in a list must be in ascending
// order, may not be negative, and may not include duplicates.

// Public Objects ------------------------------------------------------------

export class MatsList {
